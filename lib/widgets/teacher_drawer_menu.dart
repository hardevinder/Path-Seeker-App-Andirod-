...
class TeacherDrawerMenu extends StatefulWidget {
  ...
  @override
  State<TeacherDrawerMenu> createState() => _TeacherDrawerMenuState();
}

class _TeacherDrawerMenuState extends State<TeacherDrawerMenu> {
  final TextEditingController _searchController = TextEditingController();
  String _searchQuery = '';

  String? get activeRole => widget.activeRole;
            ...
            child: ListView(
              ...
              children: [
                ...
                _tile(
                  ...
                  extraAction: () =>
                      RoleSwitcher.show(Navigator.of(context).context),
                ),
                _tile(
                  context: context,
                  routeName: '/action-inbox',
                  icon: Icons.inbox_rounded,
                  title: 'My Actions & Approvals',
                ...
                _tile(
                  context: context,
                  routeName: '/teacher-performance',
                  icon: Icons.insights_rounded,
                  title: 'My Professional Growth',
                  color: const Color(0xFF2563EB),
                  subtitle:
                      'Automatic score, evidence, trends & AI growth insight',
                ),
                _tile(
                  context: context,
                ...
                _tile(
                  context: context,
                  routeName: '/teacher/staff-leadership',
                  icon: Icons.groups_3_rounded,
                  title: 'My Leadership & Responsibilities',
                  color: const Color(0xFF0F766E),
                  subtitle: 'House/wing role, linked student leaders & duties',
                ),
                _tile(
                  context: context,
                  ...
                  color: const Color(0xFFB45309),
                  subtitle:
                      'Arrival, assembly, break, dispersal & activity duties',
                ), // HOUSE_DUTY_V15 // STAFF_LEADERSHIP_V14
                _tile(
                  context: context,
                ...
                _tile(
                  ...
                  color: const Color(0xFF4F46E5),
                  subtitle: 'AI tests, written papers and evaluation',
                ),
                _tile(
                  context: context,
