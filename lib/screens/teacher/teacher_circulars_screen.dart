...
class _TeacherCircularsScreenState extends State<TeacherCircularsScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      // Keep only staff/both circulars (case-insensitive)
      _circulars = list.where((c) {
        final aud = (c.audience ?? '').toLowerCase();
        return aud == 'teacher' ||
            aud == 'coordinator' ||
            aud == 'academic_coordinator' ||
            aud == 'staff' ||
            aud == 'both' ||
            aud == 'all' ||
            aud == 'everyone';
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
            content: Text("Couldn't load circulars — try again later.")));
      }
    } finally {
          ...
          CircleAvatar(
            ...
            child: Text('${index + 1}',
                style: const TextStyle(
                    color: Color(0xFF1F7AE0), fontWeight: FontWeight.bold)),
          ),
              ...
              Row(children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(999)),
                  child: Text(
                      c.audience == 'both' ? 'All Teachers' : 'Teachers',
                      style: const TextStyle(
                          fontSize: 12,
            ...
            child: Row(children: [
              Expanded(
                  child: Column(
                      ...
                      children: [
                    const Text('Teacher Circulars',
                        style: TextStyle(
                            fontSize: 18,
                            fontWeight: FontWeight.w800,
                            color: Colors.white)),
                    const SizedBox(height: 6),
                    Text('Latest notices & attachments',
                        style:
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    Row(children: [
                      ...
                      const SizedBox(width: 8),
                      Text(formatDT(circular.createdAt),
                          style: const TextStyle(color: Colors.black54)),
                    ]),
                    const SizedBox(height: 12),
                      ...
                      if (kind == 'image')
                        ...
                        Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                color: const Color(0xFFF8FAFC)),
                            child: const Text(
                                'Preview not available. Use Open / Download.')),
                    ],
