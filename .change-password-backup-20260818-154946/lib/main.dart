...
import 'screens/school_chat_screen.dart'; // SCHOOL_CHAT_V16_IMPORT
...
import 'screens/student/student_date_sheet_screen.dart';
...
import 'screens/student/student_leadership_screen.dart'; // STUDENT_LEADERSHIP_V13
import 'screens/teacher/staff_leadership_screen.dart'; // STAFF_LEADERSHIP_V14
import 'screens/common/house_duty_screen.dart'; // HOUSE_DUTY_V15
...
import 'screens/common/parent_consent_screen.dart';
import 'screens/common/teacher_performance_screen.dart';
...
final SchoolChatNavigatorObserver schoolChatNavigatorObserver =
    SchoolChatNavigatorObserver();
  ...
  Widget build(BuildContext context) {
    return OKToast(
      child: MaterialApp(
        ...
        navigatorObservers: [
          schoolChatNavigatorObserver
        ], // SCHOOL_CHAT_FLOATING_V16_2_OBSERVER_MOUNT
        ...
        builder: (context, child) => SchoolChatFloatingOverlay(
          // SCHOOL_CHAT_FLOATING_V16_2_BUILDER
          navigatorKey: navigatorKey,
        ...
        routes: {
          ...
          '/student/leadership': (context) =>
              const StudentLeadershipScreen(), // STUDENT_LEADERSHIP_V13
          '/teacher/staff-leadership': (context) =>
              const StaffLeadershipScreen(), // STAFF_LEADERSHIP_V14
          '/house-duty': (context) => const HouseDutyScreen(), // HOUSE_DUTY_V15
          ...
          '/parent-consents': (context) => const ParentConsentScreen(),
          '/action-inbox': (context) => const ActionInboxScreen(),
          '/teacher-performance': (context) => const TeacherPerformanceScreen(),
          ...
          '/student/date-sheet': (context) => const StudentDateSheetScreen(),
          ...
          '/school-chat': (context) =>
              const SchoolChatScreen(), // SCHOOL_CHAT_V16_ROUTE
